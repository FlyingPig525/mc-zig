...
pub const dimension: Registry = .{
    ...
    .entries = &.{
        .{ .name = "minecraft:overworld", .nbt = .init(&.{
            ...
            .{ .byte = .{ .name = "has_raids", .value = 0x01 }},
            .{ .byte = .{ .name = "bed_works", .value = 0x01 }},
            .{ .byte = .{ .name = "natural", .value = 0x01 }},
            .{ .byte = .{ .name = "piglin_safe", .value = 0x00 }},
            .{ .byte = .{ .name = "respawn_anchor_works", .value = 0x00 }},
            .{ .byte = .{ .name = "ultrawarm", .value = 0x00 }},
